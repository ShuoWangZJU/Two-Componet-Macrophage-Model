...
AtomVecMolecular1::AtomVecMolecular1(LAMMPS *lmp) : AtomVec(lmp)
{
  molecular = 1;
  ...
  atom->vest_flag = 1;//Shuhao
  atom->individual = 1;//Shuhao
}
...
void AtomVecMolecular1::grow(int n)
{
  if (n == 0) grow_nmax();
  else nmax = n;
  atom->nmax = nmax;
  ...
  vest = memory->grow(atom->vest, nmax, 3, "atom:vest");//Shuhao
...
void AtomVecMolecular1::grow_reset()
{
...
void AtomVecMolecular1::copy(int i, int j, int delflag)
{
  int k;
...
int AtomVecMolecular1::pack_comm(int n, int *list, double *buf,
...
int AtomVecMolecular1::pack_comm_vel(int n, int *list, double *buf,
                                    int pbc_flag, int *pbc)
{
  int i,j,m;
...
void AtomVecMolecular1::unpack_comm(int n, int first, double *buf)
{
  int i,m,last;
  ...
  for (i = first; i < last; i++) {
    ...
    vest[i][0] = buf[m++];
    vest[i][1] = buf[m++];
    vest[i][2] = buf[m++];//Shuhao
  }
}

/* ---------------------------------------------------------------------- */

void AtomVecMolecular1::unpack_comm_vel(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecMolecular1::pack_reverse(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecMolecular1::unpack_reverse(int n, int *list, double *buf)
{
  int i,j,m;
...
int AtomVecMolecular1::pack_border(int n, int *list, double *buf,
                                  int pbc_flag, int *pbc)
{
  int i,j,m;
  double dx,dy,dz;
...
int AtomVecMolecular1::pack_border_vel(int n, int *list, double *buf,
                                      int pbc_flag, int *pbc)
{
  int i,j,m;
  double dx,dy,dz,dvx,dvy,dvz;
...
int AtomVecMolecular1::pack_border_hybrid(int n, int *list, double *buf)
{
  int i,j,m;
...
void AtomVecMolecular1::unpack_border(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecMolecular1::unpack_border_vel(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecMolecular1::unpack_border_hybrid(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecMolecular1::pack_exchange(int i, double *buf)
{
  int k;
...
int AtomVecMolecular1::unpack_exchange(double *buf)
{
  int k;
...
int AtomVecMolecular1::size_restart()
{
  int i;
...
int AtomVecMolecular1::pack_restart(int i, double *buf)
{
  int k;
...
int AtomVecMolecular1::unpack_restart(double *buf)
{
  int k;
...
void AtomVecMolecular1::create_atom(int itype, double *coord)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecMolecular1::data_atom(double *coord, imageint imagetmp,
                                 char **values)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
int AtomVecMolecular1::data_atom_hybrid(int nlocal, char **values)
{
...
void AtomVecMolecular1::pack_data(double **buf)
{
  int nlocal = atom->nlocal;
...
int AtomVecMolecular1::pack_data_hybrid(int i, double *buf)
{
...
void AtomVecMolecular1::write_data(FILE *fp, int n, double **buf)
{
  for (int i = 0; i < n; i++)
...
int AtomVecMolecular1::write_data_hybrid(FILE *fp, double *buf)
{
...
bigint AtomVecMolecular1::memory_usage()
{
  bigint bytes = 0;
  ...
  if (atom->memcheck("vest")) bytes += memory->usage(vest, nmax);//Shuhao
