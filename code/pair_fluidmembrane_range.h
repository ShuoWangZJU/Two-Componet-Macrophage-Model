...
PairStyle(fluidmembranerange,Pairfluidmembranerange)

#else

#ifndef LMP_PAIR_fluidmembrane_range_H
#define LMP_PAIR_fluidmembrane_range_H

#include "pair.h"

namespace LAMMPS_NS {

class Pairfluidmembranerange : public Pair {
 public:
  Pairfluidmembranerange(LAMMPS *lmp);
  virtual ~Pairfluidmembranerange();
