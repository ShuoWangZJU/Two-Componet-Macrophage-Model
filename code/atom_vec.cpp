  ...
  for (int i = 0; i < n; i++) {
    if (atom->individual)
      fprintf(fp,"%d " TAGINT_FORMAT " " TAGINT_FORMAT " " TAGINT_FORMAT " %g\n",
              index,(tagint) buf[i][0],(tagint) buf[i][1],(tagint) buf[i][2],buf[i][3]);
    else 
      fprintf(fp,"%d " TAGINT_FORMAT " " TAGINT_FORMAT " " TAGINT_FORMAT "\n",
              index,(tagint) buf[i][0],(tagint) buf[i][1],(tagint) buf[i][2]);
    index++;
  }
}
  ...
  for (int i = 0; i < n; i++) {
    if (atom->individual)
      fprintf(fp,"%d " TAGINT_FORMAT " " TAGINT_FORMAT " "
              ...
              index,(tagint) buf[i][0],(tagint) buf[i][1],(tagint) buf[i][2],(tagint) buf[i][3],buf[i][4]);
    else
      fprintf(fp,"%d " TAGINT_FORMAT " " TAGINT_FORMAT " "
              TAGINT_FORMAT " " TAGINT_FORMAT "\n",
              index,(tagint) buf[i][0],(tagint) buf[i][1],(tagint) buf[i][2],(tagint) buf[i][3]);
    index++;
  }
}
...
void AtomVec::pack_dihedral(double **buf)
{
  tagint *tag = atom->tag;
  ...
  for (int i = 0; i < n; i++) {
    if (atom->individual)
      fprintf(fp,"%d " TAGINT_FORMAT " " TAGINT_FORMAT " "
              ...
              index,(tagint) buf[i][0],(tagint) buf[i][1],(tagint) buf[i][2],(tagint) buf[i][3],(tagint) buf[i][4],buf[i][5]);
    else  
      fprintf(fp,"%d " TAGINT_FORMAT " " TAGINT_FORMAT " "
              TAGINT_FORMAT " " TAGINT_FORMAT " " TAGINT_FORMAT "\n",
              index,(tagint) buf[i][0],(tagint) buf[i][1],(tagint) buf[i][2],(tagint) buf[i][3],(tagint) buf[i][4]);
    index++;
  }
}
