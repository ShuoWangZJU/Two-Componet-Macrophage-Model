...
void AtomVecEllipsoid::copy(int i, int j, int delflag)
{
  ...
  // if (comm->me == 58) fprintf(stderr, "In AtomVecEllipsoid::copy at proc %d when time = %d: bonus[2202].ilocal = %d\n", comm->me, update->ntimestep, bonus[2202].ilocal);
...
{
  // fprintf(stderr, "In AtomVecEllipsoid::copy_bonus at proc %d when time = %d: i = %d, bonus[i].ilocal = %d\n", comm->me, update->ntimestep, i, bonus[i].ilocal);
