...
BondStyle(wlc/skele/all/visc,BondWLC_SKELE_ALL_VISC)

#else

#ifndef LMP_BOND_WLC_SKELE_ALL_VISC_H
#define LMP_BOND_WLC_SKELE_ALL_VISC_H
...
class BondWLC_SKELE_ALL_VISC : public Bond {
 public:
  BondWLC_SKELE_ALL_VISC(class LAMMPS *);
  virtual ~BondWLC_SKELE_ALL_VISC();
