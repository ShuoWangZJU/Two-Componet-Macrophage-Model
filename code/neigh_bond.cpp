      ...
      for (m = 0; m < num_bond[i]; m++) {
        ...
        if (newton_bond || i < atom1) {
          if (nbondlist == maxbond) {
            ...
            memory->grow(bondlist_length, maxbond," neighbor:bondlist_length");
          }
      ...
      for (m = 0; m < num_angle[i]; m++) {
        ...
        if (newton_bond || (i <= atom1 && i <= atom2 && i <= atom3)) {
          if (nanglelist == maxangle) {
            ...
            memory->grow(anglelist_area, maxangle, "neighbor:anglelist_area");
          }
      ...
      for (m = 0; m < num_dihedral[i]; m++) {
        ...
        if (newton_bond ||
          ...
          if (ndihedrallist == maxdihedral) {
            ...
            memory->grow(dihedrallist_angle,maxdihedral,"neighbor:dihedrallist_angle");
          }
