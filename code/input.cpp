...
void Input::atom_style()
{
  ...
  atom->individual = force->inumeric(FLERR,arg[0]);
    if (atom->individual)
      if (!(strcmp(arg[1],"molecular") == 0) && !(strcmp(arg[1],"sdpd") == 0) && !(strcmp(arg[1],"thermal") == 0) && !(strcmp(arg[1],"molecular1") == 0))//Shuhao
        error->all(FLERR,"The parameter individual != 0 can only be used with atom_style molecular1, molecular, sdpd, and thermal."); 
