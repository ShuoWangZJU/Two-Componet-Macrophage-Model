...
class Atom : protected Pointers {
 public:
  ...
  int individual;               // 0 = old, 1 = with individual bonds, angles, dihedrals
  double c_v;
  ...
  int dpd_flag,edpd_flag,tdpd_flag;//Shuhao
  ...
  void check_mass();
  void set_moment(const char *, int);
  void set_moment(int, double);
  void set_moment(int, char **);
