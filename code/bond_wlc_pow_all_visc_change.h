...
BondStyle(wlc/pow/all/visc/change,BondWLC_POW_ALL_VISC_CHANGE)

#else

#ifndef LMP_BOND_WLC_POW_ALL_VISC_CHANGE_H
#define LMP_BOND_WLC_POW_ALL_VISC_CHANGE_H
...
class BondWLC_POW_ALL_VISC_CHANGE : public Bond {
 public:
  BondWLC_POW_ALL_VISC_CHANGE(class LAMMPS *);
  virtual ~BondWLC_POW_ALL_VISC_CHANGE();
